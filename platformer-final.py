...
violin = pygame.mixer.music.load("assets/sounds/violin.ogg")

# Images
idle = load_image('assets/images/characters/kanga_right.png')
walk = [load_image('assets/images/characters/kanga_right.png'),]
jump = load_image('assets/images/characters/kanga_jump.png')
hurt = load_image('assets/images/characters/kanga_hurt.png')
...
tile_images = { "Sand": load_image('assets/images/tiles/platformPack_tile002.png'),
                "Dirt": load_image('assets/images/tiles/platformPack_tile004.png'),
                "Stone": load_image('assets/images/tiles/platformPack_tile016.png'),
                ...
                "Joey": load_image('assets/images/tiles/joey.png')}
        
basic_enemy_images = [ load_image('assets/images/characters/dingo_1.png'),
                       load_image('assets/images/characters/dingo_1.png') ]

platform_enemy_images = [ load_image('assets/images/characters/hunter.png'),
                          load_image('assets/images/characters/hunter.png') ] 

item_images = { "Gem": load_image('assets/images/items/sprite_3.png'),
                "Key": load_image('assets/images/items/platformPack_item014.png'),
                "Heart": load_image('assets/images/items/platformPack_item017.png')}
...
class Game():
    ...
    def show_title_screen(self):
        screen.blit(title_image["quote1"],(0,0))
    ...
    def show_lose_screen(self):
        ...
        text = font_md.render("You could have done better.", 1, WHITE)
        rect = text.get_rect()
        rect.centerx = SCREEN_WIDTH // 2
        rect.centery = 400
        screen.blit(text, rect)
    ...
    def draw_timer():
        title_text = FONT_LG.render(time, 1, BLACK)
